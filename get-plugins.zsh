...
git clone https://github.com/benmills/vimux.git bundle/vimux && rm -rf bundle/vimuxgolang/.git
git clone https://github.com/benmills/vimux-golang.git bundle/vimuxgolang && rm -rf bundle/vimuxgolang/.git
