...
#git clone https://github.com/marlun/vim-starwars bundle/starwars && rm -rf bundle/starwars/.git
#git clone https://github.com/MaxSt/FlatColor bundle/flatcolor && rm -rf bundle/flatcolor/.git
#git clone https://github.com/MichaelMalick/vim-colors-bluedrake bundle/bluedrake && rm -rf bundle/bluedrake/.git
#git clone https://github.com/nanotech/jellybeans.vim bundle/jellybeans && rm -rf bundle/jellybeans/.git
#git clone https://github.com/nice/sweater bundle/sweater && rm -rf bundle/sweater/.git
#git clone https://github.com/reedes/vim-colors-pencil bundle/pencil && rm -rf bundle/pencil/.git
...
git clone https://github.com/vim-scripts/desertEx bundle/desertex && rm -rf bundle/desertex/.git
git clone https://github.com/antlypls/vim-colors-codeschool bundle/codeschool && rm -rf bundle/codeschool/.git
git clone https://github.com/jonathanfilip/vim-lucius bundle/lucius && rm -rf bundle/lucius/.git
git clone https://github.com/jnurmine/Zenburn bundle/zenburn && rm -rf bundle/zenburn/.git
...
# Rainbow Parens
#git clone https://github.com/amdt/vim-niji bundle/niji && rm -rf bundle/niji/.git
...
#git clone https://github.com/paradigm/TextObjectify bundle/textobjectify && rm -rf bundle/textobjectify/.git
...
# JS / Json / Angular
#git clone https://github.com/burnettk/vim-angular bundle/angular && rm -rf bundle/angular/.git
